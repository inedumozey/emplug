...
const ApplyJob = () => {
		...
		<>
			<div className="d-flex align-items-center mb-4 flex-wrap">
				<h4 className="fs-20 font-w600  me-auto">Apply Job</h4>
				<div>
							...
							<div className="col-xl-6" key={index}>
								<div className="card">
									<div className="card-body">
										...
										<p className="mb-0">A data analyst collects, interprets and visualizes data to uncover insights. A data analyst assigns a numerical value to business functions so performance is assessed and compared over time. </p>
									</div>
									<div className="card-footer d-flex justify-content-between align-items-center flex-wrap">
										<div className="mb-2">
											<span><i className="fas fa-edit me-2"></i>Posted by</span>
											<p className="mb-0 text-black font-w500 mt-1">16-02-2021, 15:15 PM</p>
										</div>
										<div className="mb-2">
											<span className="me-2"><i className="fas fa-user-tie me-2"></i>HR/Admin</span>
											<Link to={"#"} className="btn btn-primary btn-md apply-job"><i className="far fa-check-circle me-2"></i>Apply Now</Link>
										</div>
									</div>
								</div>
							</div>
