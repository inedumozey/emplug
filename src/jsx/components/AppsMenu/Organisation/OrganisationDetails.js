...
import { getOrganisationPosting } from '../../../../store/actions/JobPosting/job-posting.actions'
import NewsFeedCard from '../../NewFeedCard/news-feed-card'
...
const OrganisationDetails = (props) => {
  ...
  const {
    get_single_organisation: { _id, email, industry, logo, organizationName, phone, staffs, state, website, admins, address},
  } = props.get_single_organisation;
  

  useEffect(() => {
    props.getOrganisationJobPosting(props.selected_organisation._id, props.auth.token)
  }, [])
  return (
    <Fragment>
      <Nav />
      <div className='row' style={{ margin: '2rem', marginTop: '8rem' }}>
            ...
            <div className='profile-head'>
              ...
              <div className='profile-info'>
                <div className='profile-photo'>
                  {
                    props.selected_organisation &&
                    <img
                      src={props.selected_organisation.logo}
                ...
                <div className='profile-details'>
                  <div className='profile-name px-3 pt-2'>
                    {props.selected_organisation && <h4 className='text-primary mb-0'>{props.selected_organisation.organizationName}</h4>}
                    {props.selected_organisation && <p>{props.selected_organisation.industry}</p>}
                  </div>
                  <div className='profile-email px-2 pt-2'>
                    {props.selected_organisation && <h4 className='text-muted mb-0'>{props.selected_organisation.email}</h4>}
                    <p>Email</p>
                  </div>
                  <Link
                    className='ms-auto btn btn-primary'
                    style={{ alignSelf: 'center' }}
                    to={pageRoutes.application}
                    id="custom-button"
                  >
                    Post New Job
                  </Link>
                  ...
                  <div className='profile-statistics'>
                    <div className='text-center'>
                      <div className='row'>
                        ...
                        <div className='col'>
                          {props.selected_organisation && <h3 className='m-b-0'>{props.selected_organisation.staffs.length}</h3>} <span>Staffs</span>
                        </div>
                        <div className='col'>
                          <h3 className='m-b-0'>{props.jobPosting.jobPosting.length}</h3> <span>Jobs</span>
                        </div>
                      </div>
                      <div className='mt-4'>
                        {/* <Link
                  ...
                  <div className='tab-content'>
                    ...
                    >
                      <div className='my-post-content pt-3'>
                        ...
                        {/* starts here */}
                        {
                          props.jobPosting.jobPosting.length > 0 &&
                          props.jobPosting.jobPosting.map(item => (
                            <NewsFeedCard 
                              key={item._id}
...
const mapStateToProps = state => ({
  ...
  selected_organisation: state.organisation.selected_organisation
});

const mapDispatchToProps = dispatch => ({
  getOrganisationJobPosting: (id, token) => dispatch(getOrganisationPosting(id, token))
});
