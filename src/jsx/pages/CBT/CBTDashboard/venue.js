...
function Venue(props) {
  ...
  useEffect(() => {
    if (!props.venues.length || props.selectedId === null) return
    console.log(props.venues[props.selectedId])
    setName(props.venues[props.selectedId].name)
    setCoordinator(props.venues[props.selectedId].coordinator)
    setSubCoordinators([...props.venues[props.selectedId].sub_coordinators])
    setCapacity(props.venues[props.selectedId].capacity)
    setAddress(props.venues[props.selectedId].address)
    setCountry(props.venues[props.selectedId].country)
    setState(props.venues[props.selectedId].state)
    setLocalGovernment(props.venues[props.selectedId].localGovernment)
  }, [props.venues.length])
