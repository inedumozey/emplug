...
function MedicalDashboard (props) {
  ...
  async function getAllApplicants() {
    try {
      const response = await axios(`https://employer-center-api.herokuapp.com/api/v1/application/fetch-by-job-id/${params.id}`, {
        headers: {
    ...
    <>
      ...
      >
        <div className='d-flex justify-content-between mb-4'>
          ...
          <div className='d-flex '>
            <NavLink
              to={`${routes.officialSettings.split(':')[0]}${params.id}`}
            >
              <CustomButton>
        ...
        <div className='d-flex my-4 w-100 '>
          ...
          >
            <div className='d-flex p-3 justify-content-between align-items-center'>
              <div>
                ...
                <h5 className='text-success'>All Candidates</h5>
              </div>
              <div>
                <img src={c1} />
              </div>
          ...
          >
            <div className='d-flex p-3 justify-content-between align-items-center'>
              <div>
                <p className='mb-1'>0</p>
                <h5 className='text-success'>Qualified Candidates</h5>
              </div>
              <div>
                <img src={c2} />
              </div>
          ...
          >
            <div className='d-flex p-3 justify-content-between align-items-center' >
              <div>
                <p className='mb-1'>0</p>
                <h5 className='text-success'>Not qualified Candidates</h5>
              </div>
              <div>
                <img src={c3} />
              </div>
