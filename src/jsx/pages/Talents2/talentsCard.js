...
function TalentsCard({firstName, lastName, address, lgaOfResident, stateOfResident, profilePicture}) {
    ...
    <div className="p-4 px-0">
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <p className="m-0">{address} {lgaOfResident}, {stateOfResident}</p>
          <p className="m-0">Computer Science, BSC</p>
        </div>
