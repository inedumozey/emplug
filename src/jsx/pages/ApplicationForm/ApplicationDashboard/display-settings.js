...
const DisplayDashboard = (props) =>{
	...
	const { users, displayApplicantInfo, httpMoveApplicant, updateApplicationData, httpVerifyApplicant, addCandidate } = props;
              ...
              users.map((item) => (
                <tr role='row' className='odd' key={item._id}>
                  ...
                  <td className='' >
                      ...
                      >{`${item.status === 'passed' ? 'Verified' : 'Allocate'}`}</CustomButton>
