				...
				<PerfectScrollbar  className="dlab-demo-content ps ps--active-y">	
					<div className="dlab-wrapper ">
						...
						<div className="overlay-bx dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"/search-jobs"} onClick={() => setDemoTheme(2,'ltr')} data-theme="2" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
						...
						<div className="overlay-bx dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"/my-profile"} onClick={() => setDemoTheme(3,'ltr')} data-theme="3" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
						...
						<div className="overlay-bx dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"/apply-job"} onClick={() => setDemoTheme(4,'ltr')} data-theme="4" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
						...
						<div className="overlay-bx dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"/dashboard"} onClick={() => setDemoTheme(5,'ltr')} data-theme="5" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
						...
						<div className="overlay-bx dlab-demo-bx ">
							...
							<div className="overlay-layer">
								<Link to={"/statistics"} onClick={() => setDemoTheme(6,'ltr')} data-theme="6" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
							</div>
						</div>
